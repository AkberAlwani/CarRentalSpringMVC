...
('Fairfield','USA','12345678','Akber','Ali',2,'aali@mum.edu','5122560929');


insert into customer(city,country,customerNumber,firstname,lastName,account_id,email,phoneNumber)
 values 

('Fairfield','USA','12345677','Paul','Liu',3,'aali@mum.edu','5122567799');
...
plateNumber, vehicleType_id,isavailable)
 VALUES ('1', '10', '25', 'Toyota', '2010', 'Camery', '4', 'ABC123', '1',1);

INSERT INTO vehicle (vehicleId, dailyFine, dailyRate, make, makeyear, model, numberOfSeats, 
plateNumber, vehicleType_id,isavailable) 
VALUES ('2', '10', '50', 'Toytoa', '2016', 'Camery', '4', 'ABB222', '1',1);

INSERT INTO vehicle (vehicleId, dailyFine, dailyRate, make, makeyear, model, numberOfSeats, 
plateNumber, vehicleType_id,isavailable)
 VALUES ('3', '10', '35', 'Nissa', '2017', 'Altima', '4', 'AC2323', '1',1);
